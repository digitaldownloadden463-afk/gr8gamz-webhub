...
export default function sitemap() {
  ...
  const staticRoutes = ['/', '/games', '/popular', '/new', '/a-z', '/search', '/mobile-games', '/quick-games', '/free-browser-games', '/free-online-games', '/play-free-games', '/html5-games', '/arcade-games', '/action-games', '/puzzle-games', '/racing-games', '/no-download-games', '/one-tap-games', '/games-for-mobile', '/safe-browser-games', '/best-free-browser-games', '/instant-games-online', '/play-online-games-free', '/browser-games-online', '/original-games', '/more-free-games', '/more-free-games/trending', '/more-free-games/popular', '/more-free-games/new', '/play-next', '/hot-picks', '/updates', '/collections', '/new-this-week', '/latest', '/feeds', '/seo-status', '/advertise', '/contact', '/privacy', '/gaming-deals', '/partner-disclosure', '/guides', '/affiliate-disclosure', '/partners', '/best-gaming-accessories', '/best-mobile-game-controllers', '/best-budget-gaming-headsets', '/best-gaming-keyboards', '/best-gaming-mice', '/best-gifts-for-gamers', '/best-gaming-gifts-under-25', '/best-gaming-gifts-under-50', '/best-controller-games-online', '/best-accessories-for-browser-games', '/best-razer-gaming-gear', '/best-logitech-gaming-gear'];
  const routes = [
    ...staticRoutes,
