...
function normaliseGamePix(game = {}) {
  return {
    ...
    href: `/gamepix-games/play?title=${encodeURIComponent(game.title || 'Network Game')}&url=${encodeURIComponent(game.url || '')}&w=${encodeURIComponent(game.width || 800)}&h=${encodeURIComponent(game.height || 600)}`,
...
function normaliseGameMonetize(game = {}) {
  return {
    ...
    category: game.category || 'Arcade',
    image: game.thumb || '',
    href: `/gamemonetize-games/play?title=${encodeURIComponent(game.title || 'Network Game')}&url=${encodeURIComponent(game.url || '')}&w=${encodeURIComponent(game.width || 800)}&h=${encodeURIComponent(game.height || 600)}`,
